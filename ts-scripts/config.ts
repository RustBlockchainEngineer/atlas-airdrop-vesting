...
export const DEPOSIT_TOKEN_ACCOUNT = new anchor.web3.PublicKey('-- vesting token account here --');

export const WITHDRAW_AMOUNT = new anchor.BN(10 * Math.pow(10, VESTING_TOKEN_DECIMAL));
export const WITHDRAW_TOKEN_ACCOUNT = new anchor.web3.PublicKey('-- vesting token account here --');